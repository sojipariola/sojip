...
def upgrade() -> None:
    ...
    op.add_column('projects', sa.Column('gate_policy_override', sa.String(length=20), nullable=True))
    op.add_column('tenants', sa.Column('gate_policy', sa.String(length=20), server_default='flexible', nullable=False))
